 0x00. ES6 Basics
================
 This repo is included in Specializations - Web Stack programming ― Back-end Course of Holberton School. We will cover the `basics of ES6.`
...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/qFzierDzocizeNITduMGwQ "explain to anyone"), **without the help of Google**:
...
*   [Javascript ES6 — Iterables and Iterators](https://intranet.hbtn.io/rltoken/ZNKNXIbxKIfocOKDzRgH4Q "Javascript ES6 — Iterables and Iterators")
...
*   File: [0-constants.js](https://github.com/Imanolasolo/holbertonschool-backend-javascript/blob/master/0x00-ES6_basic/0-constants.js)
